...
set(JERRY_HOST_C_FLAGS "${JERRY_HOST_C_FLAGS_INIT} -DJERRY_BUILTIN_GLOBAL_THIS=1")
set(JERRY_LIB_CFLAGS "${CMAKE_C_FLAGS} -DJERRY_BUILTIN_GLOBAL_THIS=1")
...
ExternalProject_Add(hostjerry
  ...
  CMAKE_ARGS
    ...
    -DCMAKE_C_FLAGS=${JERRY_HOST_C_FLAGS}
...
ExternalProject_Add(libjerry
  ...
  CMAKE_ARGS
    ...
    -DCMAKE_C_FLAGS=${JERRY_LIB_CFLAGS}
    -DJERRY_CMDLINE=OFF
